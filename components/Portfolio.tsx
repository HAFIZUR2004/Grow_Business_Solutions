...
const projects = [
  {
    ...
    description: "Next-gen banking infrastructure with real-time transaction tracking.",
  ...
  },
  {
    ...
    tag: "Mobile",
    title: "EcoPulse App",
    description: "Seamless IoT integration for smart energy monitoring and management.",
  ...
  },
  {
    ...
    tag: "Data System",
    title: "Nova Engine",
    description: "High-performance data processing engine for enterprise-level analytics.",
...
export default function Portfolio() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="bg-[#0b0c18] py-32 px-6 relative overflow-hidden"
    >
      ...
      <div className="max-w-[1440px] mx-auto relative z-10">
        <div className="mb-24 portfolio-title">
          <div className="flex items-center gap-4 mb-4">
            ...
            <p className="text-cyan-400 font-mono text-xs uppercase tracking-[0.5em]">Selected Works</p>
          </div>
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-cyan-400 font-mono text-[10px] uppercase tracking-widest mb-2">{project.tag}</p>
