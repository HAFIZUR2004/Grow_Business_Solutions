...
export default function DynamicPortfolioPage() {
  ...
  // 🔧 FIX: Check if we're in browser before using useScroll
              ...
              >
                ...
                <div className="relative h-64 md:h-72 overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6 z-20">
                    <span className={`px-4 py-1.5 rounded-full bg-black/60 backdrop-blur-md text-[10px] font-bold tracking-widest uppercase border ${colors.border} ${colors.text}`}>
                      {project.category}
                    </span>
                  </div>
                ...
                <div className="p-8 md:p-10 relative">
                  <div className="flex justify-between items-start mb-6">
                    <div className={`w-14 h-14 rounded-2xl bg-white/5 flex items-center justify-center ${colors.text} border border-white/10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                  ...
                  <h3 className={`text-2xl md:text-3xl font-bold mb-3 transition-colors duration-300 ${colors.text}`}>
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.slice(0, 3).map((tag, tIdx) => (
                      <span key={tIdx} className="px-3 py-1 rounded-lg bg-white/5 text-[9px] font-mono text-white/40 uppercase tracking-wider hover:bg-white/10 transition-colors">
                        {tag}
                      </span>
                    ))}
